...
export const MetaHead = memo(
  ({ metaTitle, metaDescription, metaImage }: MetaHeadProps) => {
    ...
    const defaultMetaTags = {
      title: "Moviefinder",
      description:
        "Discover popular movies with ease! Moviefinder is a Next.js app that lets you explore a wide selection of the most popular films and view their details with just a click.",
    ...
    return (
      <Head>
        ...
        <link rel="apple-touch-icon" href="/logo.jpg"></link>
        ...
        <meta
          key="keywords"
          name="keywords"
          content="test, Next.js, mdias, movies, series"
        />
