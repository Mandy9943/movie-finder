import { Box, BoxProps, CSSObject, styled } from "@mui/material";
import clsx from "clsx";
import React from "react";

interface StyledBoxProps extends CSSObject {
  textTransformStyle?: CSSObject["textTransform"];
  ellipsis?: number;
}

const StyledBox = styled(Box as any, {
  shouldForwardProp: (prop) => prop !== "textTransformStyle",
})<StyledBoxProps>(({ textTransformStyle, ellipsis }) => ({
